...
public class TypesofSensors extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_typesof_sensors);
    ...
    public void proximitySensorOnClick(View view) {
        Toast.makeText(this, "Please wait few for seconds", Toast.LENGTH_SHORT).show();
    ...
    public void gyroscopeSensorOnClick(View view) {
        Toast.makeText(this, "Please Rotate Your Mobile", Toast.LENGTH_SHORT).show();
    ...
    public void stepCounterOnClick(View view) {
        Toast.makeText(this, "Please wait few for seconds and walk", Toast.LENGTH_SHORT).show();
